...
describe('identity tests', () => {
  ...
  it('should instantiate IdentityManager', async () => {
  ...
  it('should load DID by alias', async () => {
  ...
  it('should attach signing method to DID', async () => {
    const identity = await identityManager.getIdentityByAlias('test-1');
  ...
  it('should sign and verify a VC', async () => {
  ...
  it('should sign a credential and revoke it', async () => {
  ...
  it('should attach encryption endpoint', async () => {
